...
- [Sunday migration runbook](https://github.com/mitf-dev-space/.github/blob/main/docs/SUNDAY_MIGRATION_RUNBOOK.md) (personal GitHub transfers)
- [**GitLab → GitHub migration plan**](https://github.com/mitf-dev-space/.github/blob/main/docs/GITLAB_TO_GITHUB_MIGRATION_PLAN.md) (67 repos from `10.10.20.51`)
- [GitLab repo inventory](https://github.com/mitf-dev-space/.github/blob/main/docs/GITLAB_REPO_INVENTORY.md)
- [Naming & branch standards](https://github.com/mitf-dev-space/.github/blob/main/docs/NAMING_AND_BRANCH_STANDARDS.md)
